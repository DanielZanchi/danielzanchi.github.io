...
! function(t, o) {
  ...
  function n(t, o) {
    ...
    o = function t(o) {
      ...
      return s
    }(o, n.options), this.lastKnownScrollY = 0, this.elem = t, this.tolerance = (i = o.tolerance) === Object(i) ? i : {
      down: i,
      up: i
  ...
  return window.requestAnimationFrame = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame, o.prototype = {
    ...
    constructor: n,
    init: function() {
      if (n.cutsTheMustard) return this.debouncer = new o(this.update.bind(this)), this.elem.classList.add(this.classes.initial), setTimeout(this.attachEvent.bind(this), 100), this
    },
    destroy: function() {
      var t = this.classes;
  ...
  e && (e.fn.headroom = function(n) {
    return this.each(function() {
      var t = e(this),
        o = t.data("headroom"),
        i = "object" == typeof n && n;
      i = e.extend(!0, {}, Headroom.options, i), o || ((o = new Headroom(this, i)).init(), t.data("headroom", o)), "string" == typeof n && (o[n](), "destroy" === n && t.removeData("headroom"))
    })
